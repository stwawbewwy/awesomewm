...
awful.keyboard.append_global_keybindings{
    ...
    awful.key{
        ...
        group       = 'cmus',
        on_press    = function() cmus_widget:play_pause() end,
    },
    awful.key{
        modifiers  = {},
        key         = 'XF86AudioPlay',
        description = 'play music (2)',
        group       = 'cmus',
        on_press    = function() cmus_widget:play_pause() end,
    },
    awful.key{
        modifiers   = {mod.super, mod.shift},
        key         = 'Left',
        description = 'play prev',
        group       = 'cmus',
        on_press    = function() cmus_widget:prev_track() end,
    },
    awful.key{
        modifiers   = {mod.super, mod.shift},
        key         = 'Right',
        ...
        group       = 'cmus',
        on_press    = function() cmus_widget:next_track() end,
    },
    awful.key{
        modifiers   = {},
        ...
        group       = 'brightness',
        on_press    = function() awful.spawn('xrandr --output eDP --brightness 0.6') end,
    },
    awful.key{
        modifiers   = {},
        ...
        group       = 'brightness',
        on_press    = function() awful.spawn('xrandr --output eDP --brightness 1') end,
    },
}
